...
\midrule
\endhead
Factor (Explained) & \(p\) & ESS=SSR & MSR=ESS/\((p-1)\) & F=MSR/MSE &
p-value\tabularnewline
Error (Unexplained) & \(n-p-1\) & RSS=SSE & MSE=RSS/\((n-p)\) &
&\tabularnewline
...
\subsection*{\texorpdfstring{Use the Adjusted \(R^2\) for univariate
models}{Use the Adjusted R\^{}2 for univariate models}}\label{use-the-adjusted-r2-for-univariate-models}
\addcontentsline{toc}{subsection}{Use the Adjusted \(R^2\) for
univariate models}
...
In contrast to the simple \(R^2\), the adjusted adjusted \(R_{adj}^2\)
