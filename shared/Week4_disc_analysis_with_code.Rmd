...
**14.** In order to compare LDA and QDA on your dataset, plot on the same Figure the ROC curve for each classifier we fitted and compare the correspondant AUC. What was the best model for this dataset? 
...
plot(performance(score.lda,"tpr","fpr"),col="red")
