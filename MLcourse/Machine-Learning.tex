...
\CommentTok{#ans>  [1]  2.086 -0.832 -1.147  0.111  0.981  1.783  0.363 -1.453  1.098  0.822}
...
\textbf{14.} In order to compare LDA and QDA on your dataset, plot on
the same Figure the ROC curve for each classifier we fitted and compare
the correspondant AUC. What was the best model for this dataset?

\textbf{Remark:} If you use the \texttt{ROCR} package, put
\texttt{pred.lda\$posterior{[},2{]}} and \texttt{test\_set{[},3{]}} in
