...
default template will be opened. Click on \texttt{Preview} and save your
file. Then your html report will be opened in the viewer pane. Every
time you click on \texttt{Preview} the html file in the viewer pane will
be updated. If your file is named \texttt{report.Rmd}, your report is
named \texttt{report.nb.html}.
...
\subsection*{Exercise 1: Boston data
set}\label{exercise-1-boston-data-set}
\addcontentsline{toc}{subsection}{Exercise 1: Boston data set}
