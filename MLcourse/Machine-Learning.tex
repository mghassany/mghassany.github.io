...
\CommentTok{#ans> Loading required package: factoextra}
\CommentTok{#ans> Loading required package: ggplot2}
\CommentTok{#ans> Welcome! Related Books: `Practical Guide To Cluster Analysis in R` at https://goo.gl/13EFCZ}
\CommentTok{# Calculating pca using prcomp from factoextra}
